...
class  SupportData {
  ...
  SupportData({this.terms, this.policy, this.about});
...
class About {
  ...
  About.fromJson(Map<String, dynamic> json) {
    email = json['email'] != null ? new Terms.fromJson(json['email']) : null;
    phone = json['phone'] != null ? new Terms.fromJson(json['phone']) : null;
  }
