...
class ActivityScreenRiderDetails extends StatelessWidget {
  final Driverd riderDetails;
  // final RiderDetails riderDetails;
  const ActivityScreenRiderDetails({Key? key, required this.riderDetails})
      : super(key: key);
        ...
        children: [
          Expanded(
            child: Row(
              children: [
                Container(
                  padding: const EdgeInsets.all(Dimensions.radiusSmall),
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '${riderDetails.firstName.toString().tr} ${riderDetails.lastName.toString().tr}',
                      ...
                      Text.rich(
                        TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(
                                text: riderDetails.rate.toString(),
                                style: textRegular.copyWith(
                                    fontSize: Dimensions.fontSizeDefault)),
                          ],
                        ),
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          "${riderDetails.vehicle?.brand ?? ""} - ${riderDetails.vehicle?.color.value ?? ""}",
                          style: textRegular.copyWith(
