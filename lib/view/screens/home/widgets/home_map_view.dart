...
class HomeMapViewState
    extends State<HomeMapView> {
  final markers = <MarkerId, Marker>{};
  final controller = Completer<GoogleMapController>();
  BitmapDescriptor markerIcon = BitmapDescriptor.defaultMarker;
  HomeViewController mapController=Get.put(HomeViewController());

  // @override
  //   initState() async{
  //   await mapController.getPermission();
  //   super.initState();
  // }
...
getDriversList(){
  ...
  void newLocationUpdate(LatLng latLng) async{
    var marker = RippleMarker(
        ...
        position: latLng,
        ripple: false,
        icon: BitmapDescriptor.fromBytes(await getBytesFromAsset(Images.carIcon, 100)),
        onTap: () {
