...
import 'package:google_maps_flutter/google_maps_flutter.dart';
  ...
  var distance = Math.sqrt(Math.pow(xCoordinate - double.parse(_lastXCoordinate.toString()) , 2) + Math.pow(yCoordinate - double.parse(_lastYCoordinate.toString()), 2));
  ...
  class AddEditPage extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        body: Column(
          children: [
            Text(data.latLng.first.toString())
