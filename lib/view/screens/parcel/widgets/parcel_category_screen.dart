                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: parcelController.selectedParcelCategory ==
                                      index
                                  ? Theme.of(context)
                                      .primaryColor
                                      .withOpacity(0.2)
                            ...
                            child: Image.asset(parcelController
                                .parcelCategoryList[index].categoryImage!),
                          ),
                          const SizedBox(
                          ...
                          Text(
                            parcelController
                                .parcelCategoryList[index].categoryTitle!.tr,
