    ...
    return GetBuilder<ParcelController>(builder: (parcelController){
      return Padding(
        ...
        child: Row(
          ...
          children: [
            Text('sender_details'.tr,style: textSemiBold.copyWith(color: Theme.of(context).primaryColor),),
            Row(
