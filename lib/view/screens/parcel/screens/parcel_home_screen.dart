      ...
      child: Scaffold(
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //             (timeStamp) {
                          //               Get.find<
                          //                       PaginateParcelListPackageController>()
                          //                   .onRefreshData();
                          //             },
                          //           );
                          //         }));
                          ...
                          //   height: 500,
                          //   child:
                          //       GetBuilder<PaginateParcelListHomePackageController>(
                          //         // tag: "PaginateParcelList",

                          //           init: PaginateParcelListHomePackageController(
                          ...
                          //           ),
                          //           builder: (con) {
                          //             return PaginateParcelListHomePackageView(
                          //               listPadding: const EdgeInsets.symmetric(
                          //                   horizontal: 20),
                          //               child: (entity) => ItemTrackHistory(
                          //                 data: entity,
                          //               ),
                          //               paginatedLst: (list) {
          ...
          floatingActionButton: customFloatActionButton(
              ...
              onPressed: () {
                Get.to(() => const StatusPackageScreen(),
                    binding: BindingsBuilder(() {
                  // Get.find<ParcelController>().onClickHTap(ParcelStateValue
                  //     .all);
                  ...
                  //         .onClickHTap(ParcelStateValue.all);
                  //   },
                  // );
                }));
              })),
