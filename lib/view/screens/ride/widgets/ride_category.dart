...
class RideSubCategoryWidget extends StatelessWidget {
  ...
  RideSubCategoryWidget(
      {Key? key, required this.listOfSubCategory, required this.categoryName})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RideController>(
     ...
     CategoryController categoryController=     Get.find<CategoryController>();
          ...
          _.controller?.selectedCategory(
              Get.find<CategoryController>().categoryList.first);
        }
          });
        },
        builder: (rideController) {
          return Column(
            children: [
              ...
              if (rideController.selectedCategory.value?.sub != null)
                Obx(
                  () => AnimatedContainer(
                        ...
                        ? animatedWidget(
                            ...
                            widget: RideSubCategoryWidget(
                              listOfSubCategory: rideController
                                  ...
                                  [],
                              categoryName:
                                  rideController.selectedCategoryTypeEnum,
                            ),
                            limit: 1)
                        : const SizedBox(),
                  ),
